...
pub const DEFAULT_ROW_JSON_CONTENT_VISIBLE_ROWS: usize = 8;
...
pub struct UiState {
    ...
    pub row_json_content_visible_rows: usize,
...
impl UiState {
    pub fn new() -> Self {
        Self {
            ...
            row_json_content_visible_rows: DEFAULT_ROW_JSON_CONTENT_VISIBLE_ROWS,
            ..Default::default()
        }
    }
