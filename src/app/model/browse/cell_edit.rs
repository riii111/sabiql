...
mod tests {
    ...
    #[test]
    fn begin_with_value_sets_active_state() {
    ...
    #[test]
    fn draft_equals_original_returns_false_for_pending_draft() {
        let mut state = CellEditState::default();
    ...
    #[test]
    fn draft_differs_returns_true_for_pending_draft() {
        let mut state = CellEditState::default();
        state.begin(0, 0, "Alice".to_string());
    ...
    #[test]
    fn inactive_cell_edit_returns_false_for_pending_draft() {
    ...
    #[test]
    fn clear_after_begin_returns_reset_state() {
        let mut state = CellEditState::default();
