...
mod tests {
    ...
    mod sql_resolve {
        ...
        fn insert_and_confirm_enter_insert(#[case] key: Key) {
            ...
            let action = resolve_command(&combo(key), ctx);
        ...
        fn yank_copies_query() {
            ...
            let action = resolve_command(&combo(Key::Char('y')), ctx);
        ...
        fn ctrl_aliases_scroll_by_line(
            #[case] key: Key,
    ...
    mod jsonb_resolve {
        ...
        fn enter_opens_edit_mode() {
            ...
            let action = resolve_command(&combo(Key::Enter), ctx);
        ...
        fn search_next_moves_to_match() {
            ...
            let action = resolve_command(&combo(Key::Char('n')), ctx);
        ...
        fn left_navigation_moves_text_cursor_left() {
            ...
            let action = resolve_command(&combo(Key::Char('h')), ctx);
