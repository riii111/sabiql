...
pub(crate) fn handle_help_keys_with_policy(
    combo: KeyCombo,
...
pub(crate) fn handle_confirm_dialog_keys(combo: KeyCombo) -> Action {
    keymap::resolve(&combo, keybindings::CONFIRM_DIALOG_KEYS).unwrap_or(Action::None)
}

pub(crate) fn handle_sqlite_diagnostics_keys_with_policy(
    combo: KeyCombo,
    feature_policy: &FeaturePolicy,
) -> Action {
