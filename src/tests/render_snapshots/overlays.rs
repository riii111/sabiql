...
fn sql_modal_with_completion() {
    ...
    state
        .sql_modal
        .set_editor_content_for_test("SELECT * FROM us".to_string());
...
fn sql_modal_cursor_at_head() {
    ...
    state
        .sql_modal
        .set_editor_content_with_cursor_for_test("SELECT 1".to_string(), 0);
    state.sql_modal.set_status_for_test(SqlModalStatus::Editing);
...
fn sql_modal_cursor_at_middle() {
    ...
    state
        .sql_modal
        .set_editor_content_with_cursor_for_test("SELECT 1".to_string(), 4);
    state.sql_modal.set_status_for_test(SqlModalStatus::Editing);
...
fn sql_modal_success_ddl_create_table() {
    ...
    state
        .sql_modal
        .set_editor_content_for_test("CREATE TABLE backup AS SELECT * FROM users".to_string());
    state.sql_modal.finish_adhoc_success(AdhocSuccessSnapshot {
...
fn sql_modal_error_with_message() {
    ...
    state
        .sql_modal
        .set_editor_content_for_test("SELECT * FORM users".to_string());
