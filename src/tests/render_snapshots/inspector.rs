...
fn inspector_indexes_tab_with_data() {
    ...
    state.ui.inspector_tab = crate::app::model::shared::inspector_tab::InspectorTab::Indexes;
...
fn inspector_foreign_keys_tab_with_data() {
    ...
    state.ui.inspector_tab = crate::app::model::shared::inspector_tab::InspectorTab::ForeignKeys;
    state.ui.focused_pane = FocusedPane::Inspector;
...
fn inspector_triggers_tab_with_data() {
    ...
    state.ui.inspector_tab = crate::app::model::shared::inspector_tab::InspectorTab::Triggers;
    state.ui.focused_pane = FocusedPane::Inspector;
...
fn inspector_info_tab_shows_owner_and_comment() {
    ...
    state.ui.inspector_tab = crate::app::model::shared::inspector_tab::InspectorTab::Info;
    state.ui.focused_pane = FocusedPane::Inspector;
