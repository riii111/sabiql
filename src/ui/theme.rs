...
pub const LIGHT_THEME: ThemePalette = ThemePalette {
    semantic: SemanticTokens {
        surface: SurfaceTokens {
            focus_border: Color::Rgb(0x3b, 0x7f, 0x79),
            unfocus_border: Color::Rgb(0xb8, 0xb2, 0xb6),
            highlight_border: Color::Rgb(0x2f, 0x8d, 0x84),
        },
        text: TextTokens {
            primary: Color::Rgb(0x2c, 0x28, 0x2d),
            secondary: Color::Rgb(0x5f, 0x58, 0x5d),
            muted: Color::Rgb(0x7b, 0x76, 0x80),
            dim: Color::Rgb(0x91, 0x8b, 0x94),
            accent: Color::Rgb(0x8f, 0x56, 0x36),
            placeholder: Color::Rgb(0x8f, 0x88, 0x92),
        },
        status: StatusTokens {
            success: Color::Rgb(0x2f, 0x7f, 0x68),
            error: Color::Rgb(0xa9, 0x3a, 0x35),
            warning: Color::Rgb(0x9b, 0x68, 0x1f),
            pending: Color::Rgb(0x9a, 0x63, 0x23),
            medium_risk: Color::Rgb(0xb4, 0x54, 0x32),
        },
        cursor: CursorTokens {
            fg: Color::Rgb(0x3b, 0x7f, 0x79),
            bg: Color::Rgb(0x3b, 0x7f, 0x79),
    ...
    component: ComponentTokens {
        modal: ModalTokens {
            ...
            border: Color::Rgb(0xb4, 0xab, 0xa4),
            border_highlight: Color::Rgb(0x5f, 0x83, 0x7f),
        },
        navigation: NavigationTokens {
            key_chip_bg: Color::Rgb(0xe8, 0xe3, 0xe6),
            key_chip_fg: Color::Rgb(0x8f, 0x56, 0x36),
            ...
            tab_active: Color::Rgb(0x8a, 0x75, 0x48),
            tab_inactive: Color::Rgb(0x7b, 0x76, 0x80),
            active_indicator: Color::Rgb(0x3b, 0x7f, 0x79),
        },
        editor: EditorTokens {
            current_line_bg: Color::Rgb(0xef, 0xec, 0xf2),
            completion_selected_bg: Color::Rgb(0xde, 0xdb, 0xe7),
        },
        table: TableTokens {
            result_row_active_bg: Color::Rgb(0xe5, 0xe2, 0xee),
            result_cell_active_bg: Color::Rgb(0xd7, 0xd3, 0xe5),
            cell_edit_fg: Color::Rgb(0x4a, 0x78, 0x72),
            staged_delete_bg: Color::Rgb(0xf3, 0xdd, 0xdb),
            staged_delete_fg: Color::Rgb(0xa9, 0x3a, 0x35),
            striped_row_bg: Color::Rgb(0xf4, 0xf1, 0xf3),
        },
        feedback: FeedbackTokens {
        ...
        syntax: SyntaxTokens {
            sql_keyword: Color::Rgb(0x55, 0x68, 0x87),
